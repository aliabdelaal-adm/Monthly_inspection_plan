...
def main():
    ...
    print()
    print("📊 Merge Summary:")
    print(f"   • {new_inspections} new inspection entries added")
    print(f"   • {new_inspectors} new inspectors added")
    print(f"   • {new_areas} new areas added")
    print(f"   • {new_shops} new shops added")
    print(f"   • {new_notifications} new bell notifications added")
    print()
    print(f"📈 Total counts in plan-data.json:")
    print(f"   • {len(merged_data.get('inspectionData', []))} inspection entries")
    print(f"   • {len(merged_data.get('inspectors', []))} inspectors")
    print(f"   • {len(merged_data.get('areas', []))} areas")
    print(f"   • {len(merged_data.get('shops', []))} shops")
    if 'bellNotes' in merged_data and 'notifications' in merged_data['bellNotes']:
        print(f"   • {len(merged_data['bellNotes']['notifications'])} bell notifications")
    print()

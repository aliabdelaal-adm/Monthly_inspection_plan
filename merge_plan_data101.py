#!/usr/bin/env python3
"""
Merge plan-data101.json into the main plan-data.json file.
...
def main():
    ...
    print("Merging plan-data101.json into plan-data.json")
    print()
    
    # Load files
    print("📂 Loading files...")
    main_data = load_json_file('plan-data.json')
    source_data = load_json_file('plan-data101.json')
